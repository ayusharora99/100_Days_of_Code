...
##################################################################
Spec_SP2 <- subset(Spec_SP1, Spec_SP1$Pitcher == "Menendez, Antonio")
...
```{r echo=FALSE}
####################################################################
indpitcher <- subset(Spec_SP1, Spec_SP1$Pitcher == "Menendez, Antonio")
...
```{r echo=FALSE}
p7 <- ggplot() +
  geom_point(data = truePitch, aes(truePitch$RelSide, truePitch$RelHeight, color = TaggedPitchType)) + xlab("Release Side") + ylab("Release Height") + ggtitle("Release Dimensions") + xlim(0,3) + ylim(4,7)
...
t1 <- ggplot()+
  ...
  xlab("Release Side")+
  ylab("Release Height")+
  geom_point(data = truePitch, aes(x=truePitch$negrelside, y = truePitch$RelHeight, color= TaggedPitchType))+ ggtitle("Release Dimensions") +  xlim(-3,0) + ylim(1.6, 7) 
...
t2 <- ggplot()+
  ...
  xlab("50 Feet Side")+
  ylab("50 Feet Height")+
  geom_point(data = truePitch, aes(x=truePitch$x0, y = truePitch$z0, color= TaggedPitchType))+ ggtitle("50 feet") +  xlim(-3,0) + ylim(1.6,7) 
```
